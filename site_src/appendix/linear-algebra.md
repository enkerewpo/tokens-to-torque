...
这一页讲 LoRA 用到的那部分线性代数：什么是秩、为什么一个矩阵能拆成两个小矩阵相乘、奇异值是什么。

概念按依赖顺序排，前一节是后一节的前提，从头读下来不会遇到没定义过的词。每个概念都配一个能在纸上手算的小例子。教材引用指向 Strang[^strang]，标到章节。

不读这一页也能跑通 Day 00。等你想知道“为什么 $r$ 取 16 就够”的时候再回来。
...
```{=html}
<svg class="fig light-content" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 250" role="img" aria-label="SVD 的几何：单位圆经旋转、各方向拉伸、再旋转变成椭圆"><style>.t2t-m{font-family:"JetBrains Mono Variable","JetBrains Mono","SF Mono",Menlo,Consolas,monospace}.t2t-s{font-family:"Noto Sans CJK SC","Noto Sans SC Variable","Noto Sans SC","Source Han Sans SC","PingFang SC","Microsoft YaHei",system-ui,sans-serif}</style><defs><marker id="ar" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" refX="9" refY="5.5" orient="auto"><path d="M0 1 10 5.5 0 10z" fill="#6B7280"/></marker></defs><g transform="translate(100,112)"><path d="M-76 0h152M0 -76v152" stroke="#D7DBE0" stroke-width="1"/><g transform="rotate(0)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="100" y="208" class="t2t-s" font-size="16.6" fill="#1A1A1A" text-anchor="middle" font-weight="600" >单位圆</text><path d="M184 112h26" stroke="#6B7280" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(288,112)"><path d="M-76 0h152M0 -76v152" stroke="#D7DBE0" stroke-width="1"/><g transform="rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="288" y="208" class="t2t-s" font-size="16.6" fill="#1A1A1A" text-anchor="middle" font-weight="600" >Vᵀ 旋转</text><path d="M372 112h26" stroke="#6B7280" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(476,112)"><path d="M-76 0h152M0 -76v152" stroke="#D7DBE0" stroke-width="1"/><g transform="rotate(0) scale(1.55,0.55) rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="476" y="208" class="t2t-s" font-size="16.6" fill="#1A1A1A" text-anchor="middle" font-weight="600" >Σ 拉伸</text><path d="M560 112h26" stroke="#6B7280" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(664,112)"><path d="M-76 0h152M0 -76v152" stroke="#D7DBE0" stroke-width="1"/><g transform="rotate(26) scale(1.55,0.55) rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="664" y="208" class="t2t-s" font-size="16.6" fill="#1A1A1A" text-anchor="middle" font-weight="600" >U 再旋转</text><text x="390.0" y="236" class="t2t-s" font-size="14.6" fill="#6B7280" text-anchor="middle" font-weight="400" >蓝、橙是一对正交方向；拉伸那步各自乘上一个奇异值。</text></svg>
<svg class="fig dark-content" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 250" role="img" aria-label="SVD 的几何：单位圆经旋转、各方向拉伸、再旋转变成椭圆"><style>.t2t-m{font-family:"JetBrains Mono Variable","JetBrains Mono","SF Mono",Menlo,Consolas,monospace}.t2t-s{font-family:"Noto Sans CJK SC","Noto Sans SC Variable","Noto Sans SC","Source Han Sans SC","PingFang SC","Microsoft YaHei",system-ui,sans-serif}</style><defs><marker id="ar" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" refX="9" refY="5.5" orient="auto"><path d="M0 1 10 5.5 0 10z" fill="#9AA1A9"/></marker></defs><g transform="translate(100,112)"><path d="M-76 0h152M0 -76v152" stroke="#3A404A" stroke-width="1"/><g transform="rotate(0)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="100" y="208" class="t2t-s" font-size="16.6" fill="#E8E8E8" text-anchor="middle" font-weight="600" >单位圆</text><path d="M184 112h26" stroke="#9AA1A9" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(288,112)"><path d="M-76 0h152M0 -76v152" stroke="#3A404A" stroke-width="1"/><g transform="rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="288" y="208" class="t2t-s" font-size="16.6" fill="#E8E8E8" text-anchor="middle" font-weight="600" >Vᵀ 旋转</text><path d="M372 112h26" stroke="#9AA1A9" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(476,112)"><path d="M-76 0h152M0 -76v152" stroke="#3A404A" stroke-width="1"/><g transform="rotate(0) scale(1.55,0.55) rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="476" y="208" class="t2t-s" font-size="16.6" fill="#E8E8E8" text-anchor="middle" font-weight="600" >Σ 拉伸</text><path d="M560 112h26" stroke="#9AA1A9" stroke-width="2" stroke-linecap="round" marker-end="url(#ar)"/><g transform="translate(664,112)"><path d="M-76 0h152M0 -76v152" stroke="#3A404A" stroke-width="1"/><g transform="rotate(26) scale(1.55,0.55) rotate(-34)"><circle r="44" fill="#76B900" fill-opacity=".16" stroke="#76B900" stroke-width="2.6"/><path d="M0 0h44" stroke="#0074C8" stroke-width="3" stroke-linecap="round"/><path d="M0 0v-44" stroke="#F5A623" stroke-width="3" stroke-linecap="round"/></g></g><text x="664" y="208" class="t2t-s" font-size="16.6" fill="#E8E8E8" text-anchor="middle" font-weight="600" >U 再旋转</text><text x="390.0" y="236" class="t2t-s" font-size="14.6" fill="#9AA1A9" text-anchor="middle" font-weight="400" >蓝、橙是一对正交方向；拉伸那步各自乘上一个奇异值。</text></svg>
```
...
::: {.source-link}
[在 GitHub 上查看本页源文件](https://github.com/enkerewpo/tokens-to-torque/blob/main/appendix/linear-algebra.md)
:::
