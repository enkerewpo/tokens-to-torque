...
![](../site_src/assets/fig-svd-light.svg){.fig .light-content fig-alt="SVD 的几何：旋转、各方向拉伸、再旋转"}
![](../site_src/assets/fig-svd-dark.svg){.fig .dark-content fig-alt="SVD 的几何：旋转、各方向拉伸、再旋转"}
