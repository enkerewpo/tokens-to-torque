...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="../site_src/assets/fig-svd-dark.svg">
  <img class="fig" alt="SVD 的几何：旋转、各方向拉伸、再旋转" src="../site_src/assets/fig-svd-light.svg">
</picture>
